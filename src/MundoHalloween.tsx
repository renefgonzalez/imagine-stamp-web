  ...
  return (
    <div className="min-h-screen" style={{ background: '#0D0D0D', fontFamily: "'Inter', sans-serif" }}>
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="fixed bottom-6 right-4 md:right-6 z-50 flex items-center gap-2 bg-[#25D366] text-white p-3 md:px-5 md:py-3 rounded-full font-bold shadow-[0_8px_30px_rgba(37,211,102,0.4)] hover:bg-[#1ebe57] hover:scale-105 transition-all"
      >
